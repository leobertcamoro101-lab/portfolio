      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          <div className="flex items-center gap-3 sm:gap-4 mb-10 sm:mb-12">
            <span className="font-mono text-violet-400 text-xs sm:text-sm">
              04.
            </span>
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-3">
                    <div>
                      ...
                      <p className="text-violet-400 font-medium text-sm sm:text-base">
                        {exp.company}
                      </p>
                    </div>
              ...
              <div className="flex flex-col gap-4">
                {openSource.map((item, i) => (
                  ...
                  >
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-3">
                      <div>
                        <p className="text-violet-400 font-mono text-xs sm:text-sm">
                          {item.repo}
                        </p>
                ...
                <motion.div
                  ...
                  className="bg-violet-500/5 border border-violet-500/20 rounded-2xl p-4 sm:p-5 text-center"
                >
